...
$sudo bash <(curl -L -s https://install.direct/go.sh)
    ...
    安装好 curl 之后就能安装脚本了,再次执行上面的安装命令.
```
...
**这个是所有客户端地址的列表, 可以到这个列表中去寻找需要 平台的客户端.**

{% embed url="https://github.com/v2ray/dist/" %}

### 服务器端

{% embed url="https://github.com/v2ray/v2ray-core/" %}

## 详细描述

### 平台支持 <a id="platform"></a>
...
4. Arch Linux: [packages/community/x86\_64/v2ray/](https://www.archlinux.org/packages/community/x86_64/v2ray/)
